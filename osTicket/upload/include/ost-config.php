...
#  En Docker: usar el nombre del servicio "db". En servidor físico: usar IP o localhost.
define('DBHOST','localhost');
define('DBNAME','u551401919_soporte');
define('DBUSER','u551401919_soporte');
define('DBPASS','9CXlT6y7y8F&');
